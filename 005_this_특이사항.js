...
//아래 예제는 a가 함수 안에 있는 게 아니라 Object안에 있음
const person = {
    name: 'hojun',
    age: 25,
    a() {
...
//////// 화살표함수
//a 에서 this는 person
//b 에서 this는 상위스코프(상위에서 person을 보고 있음), 즉 person
//c 에서 this는 상위스코프(상위에서 person을 보고 있음), 즉 person
const person = {
    name: 'hojun',
    age: 25,
    a() {
...
person.a() //위에서 a가 따라 올라간게 person인것이랑 비교하여, 지금의 a는 따라 올라갈게 window
